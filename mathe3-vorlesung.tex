...
\begin{tabbing}
\begin{tabular}{l}
Es sei $(K,+,*)$ ein Koerper und P ein Positionsbereich von K.\\
Ist $a\in P$ dann $a^{-1}\in P$ (fuer alle $a\in K\setminus\{ 0\}$)
\end{tabular}
\end{tabbing}
...
\begin{tabbing}
\begin{tabular}{l}
Es sei $(K,+,*,\prec)$ ein geordneter Koerper mit Nullelement 0 sowie $a,b,c\in K$ mit $a\prec b$.\\
Dann gilt :
...
a) $0\prec c$ heisst $c\in P_<$, so $c(b-a)\in P_<$ (Definition 3), d.h.\\
...
\begin{tabbing}
\begin{tabular}{l}
Es sei $(K,+,*,\preceq)$ ein geordneter Koerper und $a,b\in P_<$.\\
